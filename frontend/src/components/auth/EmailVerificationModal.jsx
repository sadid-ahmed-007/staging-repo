...
export default function EmailVerificationModal({ open, onClose, email, onVerified }) {
 ...
 {error ? (
 <div className="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 /20 ">
 <p className="font-semibold">✗ {error}</p>
 </div>
 ) : null}

 {resent ? (
 <div className="rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700 /20 ">
