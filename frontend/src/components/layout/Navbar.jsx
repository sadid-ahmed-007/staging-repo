...
export default function Navbar({ onMenuClick }) {
 ...
 return (
 <header className="fixed top-0 left-0 right-0 z-40 h-[60px] bg-[var(--bg-surface)] border-b border-[var(--border)] flex items-center justify-between px-4 sm:px-6 lg:px-8">
 ...
 className="w-[36px] h-[36px] flex items-center justify-center rounded-full bg-[var(--brand-light)] text-[var(--brand)] text-xs font-medium transition-transform hover:scale-105"
 >
 {initials}
 </button>
 ...
 className={`w-full text-left px-4 py-2 text-sm flex items-center gap-2 ${isLoggingOut ? 'text-[var(--text-muted)] cursor-not-allowed' : 'text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10'}`}
 >
 {isLoggingOut ? (
 <>
