...
import { LayoutDashboard, Users, BarChart, Layers, ShieldCheck, History, Settings, Award, UserCheck, Building2, FilePlus, FileSearch, FileEdit, ScrollText, User, LogOut, SlidersHorizontal, Loader2, Search, Bell, Trash2 } from 'lucide-react';
...
const navGroups = {
 ...
 { to: '/student/universities', label: 'Apply to University', icon: Building2 },
 { to: '/student/applications', label: 'My Applications', icon: FilePlus },
 ...
 { to: '/university/applications', label: 'Applications', icon: FileSearch },
...
export default function Sidebar({ open, onClose }) {
 ...
 <aside className={cn(
 'fixed left-0 top-[60px] z-40 h-[calc(100vh-60px)] w-[240px] border-r border-[var(--border)] bg-[var(--bg-surface)] flex flex-col transition-transform duration-200',
 ...
 'flex items-center gap-3 h-[36px] px-3 mx-2 rounded-lg text-sm font-medium transition-colors border-l-[3px]',
 isActive
 ...
 isLoggingOut ? "text-[var(--text-muted)] cursor-not-allowed" : "text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10"
 )}
 aria-label="Sign out"
 >
