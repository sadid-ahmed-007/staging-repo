...
export default function ConfirmModal({ 
 ...
 const iconStyles = {
 danger: 'bg-rose-100 text-rose-600 /40 ',
 warning: 'bg-amber-100 text-amber-600 /40 ',
 amber: 'bg-amber-100 text-amber-600 /40 ',
 primary: 'bg-blue-100 text-blue-600 /40 ',
 success: 'bg-emerald-100 text-emerald-600 /40 ',
 };
