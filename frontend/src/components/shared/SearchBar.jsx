...
export default function SearchBar({ value, onChange, placeholder = "Search certificates...", onClear, className = '' }) {
 ...
 className={cn(
 "h-[40px] w-full rounded-[8px] border border-[var(--border)] bg-[var(--bg-elevated)] pl-9 pr-9 text-sm text-[var(--text-primary)] outline-none transition-all placeholder-[var(--text-muted)]",
