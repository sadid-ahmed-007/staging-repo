...
export default function SelectField({
 ...
 className={cn(
 'flex h-10 w-full items-center justify-between rounded-md border border-[var(--border)] bg-[var(--bg-surface)] px-3 text-sm text-[var(--text-primary)] outline-none transition-all',
 hasError
 ...
 {isLoading ? (
 <div className="flex h-[36px] items-center px-[12px] text-sm text-[var(--text-muted)]">
 Loading...
 </div>
 ) : options.length === 0 ? (
 <div className="flex h-[36px] items-center px-[12px] text-sm text-[var(--text-muted)]">
 ...
 className={cn(
 'flex h-[36px] cursor-pointer items-center px-[12px] text-sm transition-colors',
