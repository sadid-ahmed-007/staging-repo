...
export default function DepartmentsManager() {
 ...
 {!loading && <span className="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-[var(--text-secondary)] ">{departments.length}</span>}
 </h2>
 ...
 <p className="text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">No departments added yet.</p>
 </div>
 ) : (
 <div className="overflow-x-auto">
 <table className="w-full text-left text-sm text-[var(--text-secondary)] dark:text-[var(--text-muted)]">
 <thead className="bg-gray-50 text-xs uppercase text-[var(--text-secondary)] ">
 <tr>
 ...
 <label htmlFor="is_active" className="text-sm font-medium text-[var(--text-secondary)] ">Active (visible in forms)</label>
 </div>
 )}
