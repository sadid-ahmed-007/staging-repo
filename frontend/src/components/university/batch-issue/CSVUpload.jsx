...
export default function CSVUpload({ onFileAccepted, disabled }) {
 ...
 className="inline-flex items-center gap-2 text-sm font-medium text-primary-600 hover:text-primary-700 dark:hover:text-primary-300"
 >
 ...
 isDragActive ? 'border-primary-600 bg-primary-50 /20' : 'border-gray-300 ',
 disabled ? 'cursor-not-allowed bg-gray-100 ' : 'hover:border-primary-400 dark:hover:border-primary-500'
 )}
 >
 <input {...getInputProps()} />
 <div className="rounded-full bg-gray-100 p-3 ">
 <UploadCloud className="h-8 w-8 text-[var(--text-muted)] dark:text-[var(--text-muted)]" />
 </div>
 ...
 <p className="mt-1 text-xs text-[var(--text-muted)]">CSV file, max 100 students</p>
 </div>
 {file && (
 <div className="flex items-center gap-3 rounded-lg bg-gray-50 p-3 ">
 <FileIcon className="h-6 w-6 flex-shrink-0 text-[var(--text-muted)]" />
