...
export default function ActivityLogs() {
 ...
 <h1 className="mt-2 text-2xl font-bold text-[var(--text-primary)] flex items-center gap-3">
 ...
 className="block rounded-lg border border-gray-300 bg-[var(--bg-surface)] py-2 pl-3 pr-10 text-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500 "
 >
 ...
 <th key={h} className="py-3 px-4 text-left text-xs font-semibold uppercase tracking-wide text-[var(--text-muted)] dark:text-[var(--text-muted)] first:pl-0">
 {h}
 </th>
 ))}
 </tr>
 ...
 <td className="px-4 py-0 pl-0 text-[var(--text-secondary)] whitespace-nowrap">
 {log.created_at ? formatDateTime(log.created_at) : '—'}
 </td>
 <td className="px-4 py-0 font-medium text-[var(--text-primary)] ">
 {log.user_name}
 </td>
 ...
 <td className="px-4 py-0 text-[var(--text-secondary)] ">
