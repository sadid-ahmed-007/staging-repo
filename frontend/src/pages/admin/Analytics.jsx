...
const CustomTooltip = ({ active, payload, label }) => {
 ...
 return (
 <div className="rounded-lg border bg-[var(--bg-surface)] p-2 shadow-sm ">
...
export default function AnalyticsDashboard() {
 ...
 <h1 className="mt-2 text-2xl font-bold text-[var(--text-primary)] sm:text-3xl">System Dashboard</h1>
 </div>
 ...
 <Card>
 <p className="text-center text-[var(--text-muted)]">Could not load analytics data.</p>
 </Card>
 ) : (
 <>
 {/* PLATFORM OVERVIEW */}
 <div className="mb-8">
 <h2 className="mb-4 text-xl font-bold text-[var(--text-primary)] border-b pb-2 ">Platform Overview</h2>
 ...
 <div>
 <p className="text-sm font-medium text-[var(--text-primary)] ">{activity.action.replace(/_/g, ' ')}</p>
 ...
 <div className="mb-8">
 <h2 className="mb-4 text-xl font-bold text-[var(--text-primary)] border-b pb-2 ">University & Enrollment Analytics</h2>
 ...
 <Card className="mt-6">
 <h3 className="mb-4 text-lg font-semibold text-[var(--text-primary)] ">Per-University Summary</h3>
 <div className="overflow-x-auto">
 <table className="w-full text-left text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">
 <thead className="bg-gray-50 text-xs uppercase text-[var(--text-secondary)] dark:text-[var(--text-muted)]">
 <tr>
 ...
 <td className="px-4 py-0 font-medium text-[var(--text-primary)] ">{inst.name}</td>
 ...
 <tr>
 <td colSpan="4" className="px-4 py-8 text-center text-[var(--text-muted)]">No university data available</td>
 </tr>
 )}
 </tbody>
 </table>
 ...
 <div>
 <h2 className="mb-4 text-xl font-bold text-[var(--text-primary)] border-b pb-2 ">Verifier & Verification Analytics</h2>
 ...
 <tr key={i} className="h-12 border-b ">
 <td className="px-4 py-0 font-medium text-[var(--text-primary)] flex items-center gap-2">
 <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary-100 text-xs font-bold text-primary-700 /30 ">
 {i + 1}
 </div>
 {inst.name}
 </td>
 ...
 <tr>
 <td colSpan="2" className="px-4 py-8 text-center text-[var(--text-muted)]">No verification data available</td>
 </tr>
 )}
 </tbody>
 </table>
