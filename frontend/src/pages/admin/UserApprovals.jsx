...
export default function UserApprovals() {
 ...
 <h1 className="mt-2 text-3xl font-bold text-[var(--text-primary)] ">Pending user registrations</h1>
 </div>
 ...
 <th key={h} className="py-3 px-3 text-left text-xs font-semibold uppercase tracking-wide text-[var(--text-muted)] dark:text-[var(--text-muted)] last:text-right">
 {h}
 </th>
 ))}
 </tr>
 ...
 <span className="text-xs text-[var(--text-secondary)] dark:text-[var(--text-muted)]">Pending</span>
 </div>
 </td>
 <td className="px-3 py-0 text-xs text-[var(--text-muted)] dark:text-[var(--text-muted)]">
 ...
 className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 px-2.5 py-1 text-xs font-medium text-[var(--text-secondary)] hover:border-primary-300 hover:text-primary-600 transition"
 >
 ...
 className="inline-flex items-center gap-1.5 rounded-lg bg-green-50 text-green-600 hover:bg-green-100 /20 dark:hover:bg-green-900/40 px-2.5 py-1 text-xs font-medium transition"
 >
 ...
 disabled={processingId === user.id}
 className="inline-flex items-center gap-1.5 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 /20 dark:hover:bg-red-900/40 px-2.5 py-1 text-xs font-medium transition"
 >
 ...
 <p className="text-sm text-[var(--text-secondary)] dark:text-[var(--text-muted)]">Please provide a reason for rejecting this application.</p>
 <textarea
 value={rejectReason}
 onChange={(e) => setRejectReason(e.target.value)}
 placeholder="Reason for rejection..."
 rows={3}
 className="w-full rounded-xl border border-gray-300 bg-[var(--bg-surface)] px-4 py-3 text-sm text-[var(--text-primary)] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 resize-none"
 />
