...
export default function SystemStatus() {
 ...
 if (status === 'loading') {
 return (
 <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold bg-gray-100 text-[var(--text-muted)] dark:text-[var(--text-muted)]">
 ...
 overallStatus === 'loading' ? 'bg-gray-200 shadow-none' :
