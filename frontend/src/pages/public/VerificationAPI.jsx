...
export default function VerificationAPI() {
 ...
 <div className="bg-[var(--bg-base)] /50 px-6 py-4 border-b border-[var(--border)] flex items-center gap-4">
 <span className="px-3 py-1 bg-blue-100 text-blue-700 /50 font-bold text-xs rounded-md tracking-wide">POST</span>
 <code className="text-[var(--text-primary)] font-mono text-sm">/api/verify/certificate</code>
 </div>
 <div className="p-6">
 <div className="mb-4">
 ...
 <div className="bg-[var(--bg-surface)] rounded-2xl border border-[var(--border)] overflow-hidden shadow-sm hover:shadow-md transition duration-300">
 <div className="bg-[var(--bg-base)] /50 px-6 py-4 border-b border-[var(--border)] flex items-center gap-4">
 <span className="px-3 py-1 bg-green-100 text-green-700 /50 font-bold text-xs rounded-md tracking-wide">GET</span>
 <code className="text-[var(--text-primary)] font-mono text-sm">/api/verify/link?token={'{token}'}</code>
 </div>
 <div className="p-6">
 <p className="text-[var(--text-secondary)] text-sm">
