 ...
 */
 ...
 <div>
 <label className="mb-1 block text-sm font-medium text-[var(--text-secondary)] ">Certificate Level</label>
 <select 
 value={level} 
 ...
 <div>
 <label className="mb-1 block text-sm font-medium text-[var(--text-secondary)] ">Issue Date Range</label>
 ...
 <h1 className="mt-2 text-2xl font-bold text-[var(--text-primary)] sm:text-3xl">Search Results</h1>
 ...
 <div className="w-full max-w-sm rounded-2xl bg-[var(--bg-surface)] p-6 shadow-2xl ">
 ...
 <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600 /30 ">
 <FileText className="h-5 w-5" />
 </div>
 <div>
 <h4 className="text-base font-semibold text-[var(--text-primary)] ">{cert.certificate_name}</h4>
 <div className="mt-1 flex flex-wrap items-center gap-2 text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">
