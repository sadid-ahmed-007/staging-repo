...
export default function BrowseUniversities() {
 ...
 <div className="rounded-xl bg-primary-50 p-3 text-primary-700 /30 shrink-0">
 ...
 <div className="flex items-start gap-2 text-sm text-[var(--text-secondary)] dark:text-[var(--text-muted)]">
 ...
 className="text-primary-600 hover:text-primary-700 dark:hover:text-primary-300 truncate"
 >
...
function ApplicationModal({ university, onClose, onSuccess }) {
 ...
 <div className="rounded-2xl bg-primary-50 p-4 /20">
 <div className="flex items-center gap-3">
 <div className="rounded-lg bg-primary-600 p-2">
 <Building2 className="h-5 w-5 text-white" />
 </div>
 <div>
 <p className="font-semibold text-[var(--text-primary)] ">{university.name}</p>
 ...
 <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 /30 /20">
 ...
 {error && (
 <div className="rounded-2xl border border-red-200 bg-red-50 p-3 /30 /20">
 ...
 Reason for Applying <span className="text-[var(--text-muted)]">(Optional)</span>
 </label>
 <textarea
 className="w-full rounded-xl border border-gray-300 bg-[var(--bg-surface)] px-4 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:focus:border-primary-400 dark:focus:ring-primary-400 min-h-[100px]"
 value={reason}
 ...
 />
 {reason.length > 0 && (
 <p className="text-xs text-[var(--text-muted)] dark:text-[var(--text-muted)] mt-1">{reason.length}/2000 characters</p>
 )}
 </div>
 ...
 className="block w-full text-sm text-[var(--text-muted)] file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100 dark:text-[var(--text-muted)] dark:file:bg-primary-900/30 dark:file:text-primary-300"
 />
 </div>
 ...
 <label htmlFor="consent_provided" className="text-sm text-[var(--text-secondary)] cursor-pointer">
