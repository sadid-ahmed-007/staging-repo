...
export default function StudentDashboard() {
 ...
 />
 <StatCard 
 icon={<Shield className="h-5 w-5 text-[var(--text-muted)]" />} 
 ...
 <span className="inline-flex items-center gap-1.5 rounded-full border border-amber-300 bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700 /40 /40 ">
