...
function DetailRow({ label, value, icon: Icon }) {
 ...
 <span className="w-36 flex-shrink-0 text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">{label}</span>
...
export default function VerifierVerifyCertificate() {
 ...
 <h1 className="mt-2 text-3xl font-bold text-[var(--text-primary)] ">Verify Certificate</h1>
 ...
 <div className="flex gap-1 p-1 bg-gray-50 border border-gray-100 /50 rounded-xl mb-6">
 ...
 tab === id
 ? 'bg-[var(--bg-surface)] text-primary-600 shadow-sm border border-gray-200/50 '
 : 'text-[var(--text-muted)] hover:text-[var(--text-primary)] dark:text-[var(--text-muted)] dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-700/50'
 }`}
 >
 ...
 {/* Error banner */}
 {error && !result && (
 <div className="mb-4 rounded-xl bg-red-50 /20 border border-red-200 px-4 py-3 flex items-start gap-3">
 ...
 <Link2 className="h-5 w-5 text-[var(--text-muted)] group-focus-within:text-primary-500 transition-colors" />
 </div>
 <textarea
 value={linkInput}
 ...
 rows={3}
 className="w-full rounded-xl border border-gray-300 bg-[var(--bg-surface)] pl-10 pr-4 py-2.5 text-sm text-[var(--text-primary)] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 dark:placeholder-gray-500 resize-none transition-all"
 />
 </div>
 ...
 <div className="mt-auto pt-5 border-t border-gray-100 flex items-start gap-3">
 <div className="mt-0.5 p-1.5 bg-green-50 /20 rounded-lg">
 <ShieldCheck className="h-4 w-4 text-green-600 " />
 </div>
 <div>
 <h4 className="text-sm font-medium text-[var(--text-primary)] ">Secure Verification</h4>
 <p className="text-xs text-[var(--text-muted)] dark:text-[var(--text-muted)] mt-0.5 leading-relaxed">
 ...
 <History className="h-6 w-6 text-gray-300 dark:text-[var(--text-secondary)]" />
 </div>
 <div>
 <p className="text-sm font-medium text-[var(--text-secondary)] ">No verifications yet</p>
 <p className="text-xs text-[var(--text-muted)] dark:text-[var(--text-muted)] mt-1">Start verifying certificates to see your history here</p>
 </div>
 </div>
 ) : (
 ...
 className="w-full rounded-xl border border-gray-100 hover:border-primary-200 dark:hover:border-primary-700 px-3 py-3 text-left transition hover:bg-gray-50 dark:hover:bg-gray-800/50 group"
 >
 ...
 <span className="text-[10px] text-[var(--text-muted)] dark:text-[var(--text-muted)]">
 ...
 <div className="h-16 w-16 flex items-center justify-center rounded-full bg-primary-100 /30">
 <ShieldCheck className="h-8 w-8 text-primary-600 animate-pulse" />
 </div>
 <div className="text-center">
 <p className="text-lg font-semibold text-[var(--text-primary)] ">Verifying details securely...</p>
 <p className="text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)] mt-1">Please wait a moment while we check the blockchain/database.</p>
 </div>
 ...
 <h2 className="text-xl font-bold text-green-600 ">Certificate Verified Successfully</h2>
 </div>

 <div className="space-y-0.5 bg-gray-50 /50 border border-gray-100 rounded-xl p-4">
 ...
 <div>
 <p className="text-lg font-bold text-amber-600 ">Certificate Revoked</p>
 <p className="mt-1 text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">
 ...
 <div className="mt-4 bg-red-50 /20 rounded-xl p-4 text-left border border-red-100 /30">
 <p className="text-sm font-semibold text-red-800 mb-2">How to solve this:</p>
 <ul className="text-sm text-red-700 list-disc list-inside space-y-1.5">
 ...
 <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary-100 text-xs font-bold text-primary-600 /30 ">1</span>
 ...
 <li className="flex gap-3 items-start">
 <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary-100 text-xs font-bold text-primary-600 /30 ">2</span>
 ...
 <li className="flex gap-3 items-start">
 <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary-100 text-xs font-bold text-primary-600 /30 ">3</span>
